...
near call $accountId new_default_meta "{\"owner_id\": \"$master\"}" --accountId $accountId
...
near call $accountId nft_mint "{\"token_id\": \"0\", \"receiver_id\": \"$accountId\"}" --accountId $accountId --amount 0.0125 --gas=300000000000000
